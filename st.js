...
// let res = prompt("what is your result");if (res >= 90) { document.write("gooooooood");} else if (res >= 80) { document.write("good");} else if (res >= 50) {  document.write("bad ");}
...
//let mosleh = document.getElementById('2')

//mosleh.nextElementSibling.innerHTML='best';

//console.log(mosleh.nextElementSibling)
